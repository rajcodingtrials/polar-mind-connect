      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="relative">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <Card className="bg-blue-100 hover:bg-blue-200 border-blue-200 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <CardContent className="p-6">
                <div className="flex items-center">
                  <div className="p-3 rounded-xl bg-blue-200 backdrop-blur-sm">
                    <Calendar className="h-8 w-8 text-blue-800" />
                  </div>
                  <div className="ml-4">
                    <p className="text-sm font-medium text-blue-800">Today's Sessions</p>
            ...
            <Card className="bg-amber-100 hover:bg-amber-200 border-amber-200 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <CardContent className="p-6">
                <div className="flex items-center">
                  <div className="p-3 rounded-xl bg-amber-200 backdrop-blur-sm">
                    <Users className="h-8 w-8 text-amber-800" />
                  </div>
                  <div className="ml-4">
                    <p className="text-sm font-medium text-amber-800">Total Sessions</p>
            ...
            <Card className="bg-emerald-100 hover:bg-emerald-200 border-emerald-200 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <CardContent className="p-6">
                <div className="flex items-center">
                  <div className="p-3 rounded-xl bg-emerald-200 backdrop-blur-sm">
                    <DollarSign className="h-8 w-8 text-emerald-800" />
                  </div>
                  <div className="ml-4">
            ...
            <Card className="bg-orange-100 hover:bg-orange-200 border-orange-200 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <CardContent className="p-6">
                <div className="flex items-center">
                  <div className="p-3 rounded-xl bg-orange-200 backdrop-blur-sm">
                    <Star className="h-8 w-8 text-orange-800" />
                  </div>
                  <div className="ml-4">
                    <p className="text-sm font-medium text-orange-800">Rating</p>
