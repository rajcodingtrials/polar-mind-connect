...
const UserDashboard = () => {
  ...
  if (profileLoading || loading) {
    return (
      <div className="min-h-screen bg-background gradient-bg stars-bg">
        <Header />
    ...
    <div className="min-h-screen bg-background gradient-bg stars-bg">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-white/80">Manage your therapy sessions and profile here.</p>
        </div>

        <Tabs defaultValue="sessions" className="space-y-6">
          <TabsList className="grid w-full grid-cols-3 bg-card/10 backdrop-blur-sm">
            <TabsTrigger value="sessions" className="data-[state=active]:bg-card data-[state=active]:text-foreground">
              <Calendar className="w-4 h-4 mr-2" />
              My Sessions
            </TabsTrigger>
            <TabsTrigger value="ratings" className="data-[state=active]:bg-card data-[state=active]:text-foreground">
                ...
                {upcomingSessions.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {upcomingSessions.map((session) => {
                      ...
                      return (
                        <div key={session.id} className="flex items-center justify-between p-4 bg-surface-elevated/50 rounded-lg border">
                          <div className="flex items-center space-x-4">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">{session.duration_minutes} minutes</p>
                            </div>
                          </div>
          ...
          <TabsContent value="ratings" className="space-y-6">
            <Card className="bg-card/20 backdrop-blur-sm border-border/40">
              <CardHeader>
                <CardTitle className="text-foreground">Your Session Ratings</CardTitle>
              </CardHeader>
              <CardContent>
                {sessionRatings.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {sessionRatings.map((rating) => {
                      ...
                      return (
                        <div key={rating.id} className="p-4 bg-surface-elevated/50 rounded-lg border">
                          ...
                          {rating.feedback_text && (
                            <p className="text-sm text-muted-foreground mb-2">{rating.feedback_text}</p>
                          )}
